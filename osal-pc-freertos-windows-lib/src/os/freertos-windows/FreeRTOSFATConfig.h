/*
 * Notes:
 *     Because FreeRTOS does not have realtime clock support built in, turned off
 *     The option for timestamps
 *
 *     Because FreeRTOS does not have built in network or console support, turned
 *     off the logging functionality
 *
 * Based on FreeRTOS-Plus/Demo/FreeRTOS_Plus_TCP_and_FAT_Windows_Simulator/FreeRTOSFATConfig.h
 * from the "160919 FreeRTOS Labs download" from https://www.freertos.org/FreeRTOS-Labs/downloads/160919_FreeRTOS_Labs.zip?dl=0
